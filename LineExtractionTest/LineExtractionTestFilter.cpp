#include "LineExtractionTestFilter.h"
typedef struct {
	PF_Boolean			isWhite;
	PF_Pixel			color;
	PF_Pixel16			color16;
	...
	T* outP)
{
	...
	PF_FpLong a = inP->alpha;
	PF_FpLong av = (PF_FpLong)inP->alpha / maxChannel;
	PF_FpLong r = (PF_FpLong)inP->red * av;
	PF_FpLong g = (PF_FpLong)inP->green * av;
	PF_FpLong b = (PF_FpLong)inP->blue *av;

	PF_FpLong lv = AE_CLAMP((r + g + b) / 3, 0, maxChannel);
