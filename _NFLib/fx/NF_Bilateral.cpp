...
)
{
    ...
    case PF_PixelFormat_ARGB128:
        err = suitesP->Iterate8Suite2()->iterate_generic(
            output->height, &info, BilateralFilterGeneric<PF_PixelFloat, float, 0>);
        break;

    case PF_PixelFormat_ARGB64:
        err = suitesP->Iterate8Suite2()->iterate_generic(
            output->height, &info, BilateralFilterGeneric<PF_Pixel16, A_u_short, 32768>);
        break;

    case PF_PixelFormat_ARGB32:
        err = suitesP->Iterate8Suite2()->iterate_generic(
            output->height, &info, BilateralFilterGeneric<PF_Pixel8, A_u_char, 255>);
        break;
