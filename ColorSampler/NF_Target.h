...
#define NF_NAME			"NF-ColorSampler"
#define NF_MATCHNAME	"NF-ColorSampler"


//-----------------------------------------------------------------------------------
//プラグインの説明に使われる文字
#define NF_DESCRIPTION	"This is a rip-off of Silverlink’s “MaskDropper.aex.” Sorry, K."
