...
enum {
    ...
    PF_ExtendedSuiteTool_OBJECTSELECT,
    PF_ExtendedSuiteTool_CUBE,
    PF_ExtendedSuiteTool_SPHERE,
    PF_ExtendedSuiteTool_PLANE,
    PF_ExtendedSuiteTool_TORUS,
    PF_ExtendedSuiteTool_CONE,
    PF_ExtendedSuiteTool_CYLINDER,
};
