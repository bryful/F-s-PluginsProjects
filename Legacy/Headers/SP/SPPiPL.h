...
typedef SPUInt32 PIType;
    ...
    // 'wa64' <PIWinARM64CodeProperty> Windows ARM64 code descriptor. See struct below.
    #define PIWinARM64CodeProperty (PIType)0x77613634L
...
requirement. See @ref PIWinARM64CodeProperty above. */
typedef struct PIWinARM64CodeDesc
{
    char fEntryName[1];
} PIWinARM64CodeDesc;
