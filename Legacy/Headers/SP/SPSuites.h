 ...
 **/
    ...
    */
    typedef struct SPSuitesSuite
    {
        ...
        */
        SPAPI SPErr (*AllocateSuiteList)(
            SPStringPoolRef stringPool, SPPluginListRef plugins, SPSuiteListRef* suiteList);
        ...
        */
        SPAPI SPErr (*ReleaseSuite)(
            SPSuiteListRef suiteList, const char* name, int32 apiVersion, int32 internalVersion);
        ...
        */
        SPAPI SPErr (*FindSuite)(
            SPSuiteListRef suiteList, const char* name, int32 apiVersion, int32 internalVersion, SPSuiteRef* suite);
    ...
    SPAPI SPErr SPAcquireSuite(
        SPSuiteListRef suiteList, const char* name, int32 apiVersion, int32 internalVersion, const void** suiteProcs);

    /** Internal */
    SPAPI SPErr SPReleaseSuite(SPSuiteListRef suiteList, const char* name, int32 apiVersion, int32 internalVersion);

    /** Internal */
    SPAPI SPErr
    SPFindSuite(SPSuiteListRef suiteList, const char* name, int32 apiVersion, int32 internalVersion, SPSuiteRef* suite);
