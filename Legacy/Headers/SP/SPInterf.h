...
*/
    typedef struct SPInterfaceSuite
    {
        ...
        */
        SPAPI SPErr (*SendMessage)(
            SPPluginRef plugin, const char* caller, const char* selector, void* message, SPErr* result);
        ...
        */
        SPAPI SPErr (*StartupExport)(SPPluginListRef pluginList, const char* name, int32 version, int32* started);

    } SPInterfaceSuite;

    /** Internal */
    SPAPI SPErr
    SPSendMessage(SPPluginRef plugin, const char* caller, const char* selector, void* message, SPErr* result);
    ...
    /** Internal */
    SPAPI SPErr SPStartupExport(SPPluginListRef pluginList, const char* name, int32 version, int32* started);
