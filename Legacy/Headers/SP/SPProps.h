 ...
 **/
    ...
    */
    typedef struct SPPropertiesSuite
    {
        ...
        */
        ...
        but does not return these objects.
            ...
            @see \c #AddProperty()
        */
        SPAPI SPErr (*AddProperties)(
            SPPropertyListRef propertyList, PIPropertyList* pList, int32 refCon, int32 cacheable);
    ...
    /** Internal */
    SPAPI SPErr SPAddProperties(SPPropertyListRef propertyList, PIPropertyList* pList, int32 refCon, int32 cacheable);

    /** Internal */
    SPAPI SPErr SPAddProperty(
        SPPropertyListRef propertyList,
        PIType vendorID,
        PIType propertyKey,
        int32 propertyID,
    ...
    /** Internal */
    SPAPI SPErr SPFindProperty(
        SPPropertyListRef propertyList, PIType vendorID, PIType propertyKey, int32 propertyID, SPPropertyRef* property);
    ...
    /** Internal */
    SPAPI SPErr SPFindPropertyLocal(
        SPPropertyListRef propertyList, PIType vendorID, PIType propertyKey, int32 propertyID, SPPropertyRef* property);
