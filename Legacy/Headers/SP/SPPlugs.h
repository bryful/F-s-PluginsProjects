    ...
    */
        ...
        */
        ...
        and returns it.
            ...
            @see \c #SPPropertiesSuite
        */
        SPAPI SPErr (*FindPluginProperty)(
            SPPluginRef plugin, PIType vendorID, PIType propertyKey, int32 propertyID, PIProperty** p);
 ...
 **/
    ...
    typedef struct SPXPlatPluginsSuite
    {
        ...
        */
        ...
        /** Creates a new plug-in object and adds it to a plug-in list.
            ...
            @see \c #AllocatePluginList(), \c #SPAdaptersSuite
        */
        SPAPI SPErr (*AddXPlatPlugin)(
            SPPluginListRef pluginList,
            const XPlatFileSpec* fileSpec,
            PIPropertyList* PiPL,
            const char* adapterName,
            void* adapterInfo,
            SPPluginRef* plugin);
    ...
    */
    ...
    /** Internal */
    SPAPI SPErr
    SPFindPluginProperty(SPPluginRef plugin, PIType vendorID, PIType propertyKey, int32 propertyID, PIProperty** p);
