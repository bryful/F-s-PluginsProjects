...
// Alias for clarity
typedef A_u_long PFVersionInfo;
...
enum {
    ...
    PF_OutFlag2_SUPPORTS_DIRECTX_RENDERING      = 1L << 29      // PF_Cmd_GLOBAL_SETUP. Filter must also set PF_OutFlag2_SUPPORTS_GPU_RENDER_F32
};
