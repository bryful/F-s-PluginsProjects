...
#define AEGP_INITFUNC_MINOR_VERSION			9
	...
	typedef struct _AEGP_ColorProfile		*AEGP_ConstColorProfileP;
	typedef struct _AEGP_Guid				*AEGP_GuidP;
#endif
...
#define kAEGPCompSuiteVersion12		26 /* frozen in AE 24.0 */

typedef struct AEGP_CompSuite12 {
...
#define kAEGPEffectSuiteVersion5		5 /* frozen in AE 24.1 */

typedef struct AEGP_EffectSuite5 {
	...
	SPAPI A_Err	(*AEGP_GetIsInternalEffect)(
					AEGP_InstalledEffectKey		installed_effect_key,	/* >> */
					A_Boolean					*isInternal);			/* << */
...
#define kAEGPColorSettingsSuiteVersion6	7	// frozen in AE 25.1; Add APIs to get color management settings (LUTInterpolationMethod , GraphicsWhite, ColorSpaceAware) and working color space for a project opened from PR .

typedef struct AEGP_ColorSettingsSuite6 {
	...
	SPAPI	A_Err (*AEGPD_IsColorSpaceAwareEffectsEnabled)(
		AEGP_PluginID			aegp_plugin_id,					// >>
		A_Boolean				*outIsGetColorAwareEnabled);	// <<
	
	SPAPI	A_Err (*AEGPD_GetLUTInterpolationMethod)(
		AEGP_PluginID			aegp_plugin_id,					// >>
		A_u_short				*outLUTInterpolationMethod);	// <<
	
	SPAPI	A_Err (*AEGPD_GetGraphicsWhiteLuminance)(
		AEGP_PluginID			aegp_plugin_id,					// >>
		A_u_short				*outGraphicsWhiteLuminance);	// <<
	
	SPAPI	A_Err (*AEGPD_GetWorkingColorSpaceId)(
		AEGP_PluginID			aegp_plugin_id,					// >>
		AEGP_GuidP workingColorSpaceGuid);	// <<
...
#define kAEGPLightSuiteVersion3		3 /* frozen in AE 24.4 */

typedef struct AEGP_LightSuite3 {
	...
	SPAPI A_Err	(*AEGP_GetLightSource)(
					AEGP_LayerH				light_layerH,		/* >> */
					AEGP_LayerH				*light_sourcePH);	/* << */

	SPAPI A_Err	(*AEGP_SetLightSource)(
					AEGP_LayerH				light_layerH,		/* >> */
					AEGP_LayerH				light_sourceH);		/* >> */
