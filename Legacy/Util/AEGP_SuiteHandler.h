...
private:
	...
	struct Suites {
		...
		AEGP_CompSuite12			*comp_suite12P;
		...
		AEGP_LightSuite3			*light_suite3P;
		...
		AEGP_EffectSuite5			*effect_suite5P;
...
// clang-format on
		...
		AEGP_SUITE_RELEASE_BOILERPLATE(light_suite3P, kAEGPLightSuite, kAEGPLightSuiteVersion3);
		...
		AEGP_SUITE_RELEASE_BOILERPLATE(effect_suite5P, kAEGPEffectSuite, kAEGPEffectSuiteVersion5);
...
// clang-format on
	...
	AEGP_SUITE_ACCESS_BOILERPLATE(CompSuite, 12, AEGP_, comp_suite12P, kAEGPCompSuite, kAEGPCompSuiteVersion12);
	...
	AEGP_SUITE_ACCESS_BOILERPLATE(LightSuite, 3, AEGP_, light_suite3P, kAEGPLightSuite, kAEGPLightSuiteVersion3);
	...
	AEGP_SUITE_ACCESS_BOILERPLATE(EffectSuite, 5, AEGP_, effect_suite5P, kAEGPEffectSuite, kAEGPEffectSuiteVersion5);
